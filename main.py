...
t15 = Polygon([(0.5-1./8,1),(0.5+1./8,1),(0.5+1./8,0.5+1./8),(1,0.5+1./8),(1,0.5-1./8),(0.5+1./8,0.5-1./8),(0.5-1./8,0.5+1./8)])
...
for i in xrange(2):
    population, bestfitness, bestchromosome = newGeneration(source, target, population, True)
    if bestfitness>0.97:
        break
